    ...
    <Dialog open={isOpen} onClose={handleClose}>
      <div className="items-stretch shadow-lg bg-white flex flex-col p-3 rounded-lg">
        <DialogTitle
          ...
          className="justify-between items-stretch flex gap-5 max-md:max-w-full "
        >
        ...
        <DialogContent
          ...
          className="text-zinc-700 text-base font-normal leading-4 tracking-tight items-stretch rounded bg-gray-100 justify-center mt-3 px-3 py-4 max-md:max-w-full"
        >
          <span className="">Are you sure you want to</span>
        ...
        <form className="items-stretch self-stretch flex flex-col pt-3">
          <header className="justify-between items-stretch flex gap-2.5 pl-20">
            ...
            <DialogActions>
              ...
              <Button
                className="text-white text-center text-sm leading-4 tracking-tight items-stretch rounded bg-blue-900 grow justify-center px-6 py-2 max-md:px-5 no-hover-effect text-transform-none"
                onClick={() => handleConfirmation(false)}
