...
import { faCaretDown, faHouse, faUser } from '@fortawesome/free-solid-svg-icons';
...
const Header = ({ isHome = false }) => {
  ...
  const handleClose = () => {
    ...
    loginClient.federatedLogout("3ltd5pa3k574vbblodke8ofd5c", `${import.meta.env.VITE_APP_URL}/logout`) // `${import.meta.env.VITE_APP_URL}/home`
    setAnchorEl(null);
  };
    ...
    <div className='main-header flex flex-row items-center justify-between mt-1'>
      ...
      <div className="user-info-container">
        <div className="user-icons-div">
          <i className='home-icon-style' onClick={() => {
            if (!isHome) navigate('/creator/modellist')
          }}>
            {/* <img src={homeIcon} /> */}
            <FontAwesomeIcon icon={faHouse} className={!isHome ? 'home-icon-style' : 'home-icon-style-inactive'} />
          </i>
