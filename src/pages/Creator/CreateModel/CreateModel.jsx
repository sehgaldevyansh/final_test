...
} from "../../../store/apis/createModelApi";
...
const ViewModal = () => {
  ...
  const handelDevelopmentChange = (e, tar) => {
    ...
    setFetchedData((prevData) =>
      produce(prevData, (draft) => {
        draft.modelData.General_info.Development_Responsibility =
          e.target.value;
      })
    );
    setFilledStatus((prevStatus) => ({
  ...
  useEffect(() => {
    ...
    console.log(
      ...
      milestoneFilledTrack.filter((obj) => !obj?.filled)?.length
    );
  ...
  useEffect(() => {
    if (fetchedData) {
      console.log(
        "object keys",
        Object?.keys(fetchedData?.modelData?.Milestones)
      );
      setMilestoneFilledTrack(
        Object?.keys(fetchedData?.modelData?.Milestones).map((key) => {
          return {
            mname: key,
            filled: false,
          };
  ...
  return (
    <div className="create-model-page-container">
      ...
      <div className="create-modal-main-container">
        ...
        <div className="create-model-form gap-2">
          <div className="general-information-container">
            ...
            <div className="general-information-input-container flex flex-col gap-2">
              <div className="flex items-start gap-2 justify-evenly flex-grow-1 ">
                ...
                {!fetchedData ? (
                  <Skeleton
                    data-testid="milestones-skeleton1"
                    variant="rectangular"
                    width="100%"
                    height={40}
                  />
              ...
              <div className="flex items-start gap-2 justify-evenly flex-grow-1">
                ...
                {!fetchedData ? (
                  <Skeleton
                    data-testid="milestones-skeleton2"
                    variant="rectangular"
                    width="100%"
                    height={40}
                  />
              ...
              <div className="flex items-start gap-2">
                ...
                {!fetchedData ? (
                  <Skeleton
                    data-testid="milestones-skeleton3"
                    variant="rectangular"
                    width="100%"
                    height={40}
                  />
              ...
              <div className="flex items-start gap-2">
                ...
                {!fetchedData ? (
                  <Skeleton
                    data-testid="milestones-skeleton4"
                    variant="rectangular"
                    width="100%"
                    height={40}
                  />
              ...
              <div className="flex gap-2 flex-grow-1" style={{ flexGrow: "1" }}>
                <div className="">
          ...
          <div className="milestones-container">
            ...
            {!fetchedData ? (
              <Skeleton
                data-testid="milestones-skeleton5"
                variant="rectangular"
                width="100%"
                height={380}
              />
              ...
              <div className="milestones-item-container flex gap-2 flex-col">
                {Object?.keys(fetchedData?.modelData?.Milestones)?.map(
                  (milestoneKey, index) => {
                    const milestone =
                      fetchedData?.modelData?.Milestones[milestoneKey];
      ...
      <SubmitConfirmComponent
        ...
        handleClose={handleConfirmSubmitClose}
