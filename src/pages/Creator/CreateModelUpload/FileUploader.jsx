...
const FileUploader = ({
  ...
  const [showFileSummaryComponent, setShowFileSummaryComponent] =
    useState(false);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (uploadResponse.ok) {
        ...
        else if ((fileType = "uncommon-activity-master"))
          APIPostfixUrl = "uncommon-activity-master";
        axios({
          method: "POST",
          data: {
        ...
        <div className="">
          {uploadLoader ? (
            ...
            <FileSummaryComponent
              ...
              fileProperty={
                uploadedFileData?.heading?.includes("People")
                  ? "Engineers"
                  : "Unique Blocks"
              }
              noOfBlocks={
                uploadedFileData?.heading?.includes("People")
                  ? uploadedFileData?.data?.numberOfEngineers
                  : uploadedFileData?.data?.numberOfUniqueBlocksAdded
              }
