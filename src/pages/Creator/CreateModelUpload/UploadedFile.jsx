    ...
    () => [
      {
        ...
        sortable: true,
        cell: (row) => (
          <span style={{ color: "#171C8F" }}>
            {row.Name.substring(row.Name.lastIndexOf("_") + 1)}
          </span>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              params?.type !== "viewfull" ? (
                <i className="" onClick={() => handleDeleteButton(row.Name)}>
                  <img src={trashIcon} />
                </i>
              ) : null}
