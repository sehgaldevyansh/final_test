  ...
  return (
    ...
    >
      ...
      <div className="flex-col relative flex  w-full items-center pl-8 pr-8  max-md:max-w-full max-md:pl-5  modellist-container gap-6">
          ...
          <Box>
            <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
              ...
              >
                ...
                <Tab
                  disabled
                  label="Step 2: COMMON/UN-COMMON MAPPING"
                  {...a11yProps(0)}
                  sx={{
                    textTransform: "none",
                    fontSize: "12px",
        ...
        <div
          className="rounded  flex w-full justify-start  h-full items-start max-md:max-w-full max-md:pr-5 gap-3"
        ...
        >
          <div className="rounded shadow bg-white flex grow flex-col w-full p-4 h-full gap-4">
            <div className="filler-comments-for-checker-heading ">
              Comments for Checker
            </div>
            <div
              className="flex justify-between border p-4 gap-4 filler-comments-div "
              style={{ height: "55vh" }}
            >
              <div className="">
                <div className="">Comments</div>
                <div className="" style={{ fontSize: "12px", color: "#bbb" }}>
                  (Max 500 Characters)
                </div>
              </div>
