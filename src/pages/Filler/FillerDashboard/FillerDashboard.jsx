...
import { Box, FormControl, IconButton, InputLabel, MenuItem, Modal, Select, Tab, Tabs } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import { useEffect, useState } from 'react';
import { fetchAllBaseModelByEmail, fetchAllBlockByEmailAndBaseSystem, fetchAllCommonUncommList, fetchAllSystemByEmailAndBase } from './api';
...
const FillerDashboard = () => {
    ...
    const graphData = {
        ...
        datasets: [{
            data: [commonValue, uncommonValue, nAValue, necessaryValue, commonMonitoringReqValue],
            backgroundColor: [
                '#118DFF', // Common color
                '#12239E',
                '#c3c3c3',
    ...
    return (
        <div className=" flex flex-col items-stretch h-full" style={{
            ...
            <div className="modal-list-main-container">
                <NavigationPathComponent paths={[{ name: 'DCMS Models', path: '/filler/modellist' }]} current='Dashboard' /></div>
            <div className="flex-col relative flex  w-full items-center pl-8 pr-8  max-md:max-w-full max-md:pl-5  modellist-container">
                <div className="items-stretch flex flex-col w-full  max-md:max-w-full max-md:flex-wrap">
                    <div className="text-neutral-700 font-semibold tracking-tight  whitespace-nowrap my-auto mt-2" style={{ fontSize: '24px' }}>
                        Dashboard
                    </div>
                    <div>
                    ...
                    <Box>
                        <Tabs value={value} onChange={handleChange} centered aria-label="model tabs">
                        ...
                        <div role="tabpanel" hidden={value !== 0}>
                            ...
                            <div className="">
                                <div className="flex-col relative flex  w-full mt-5 max-md:max-w-full max-md:pl-5  modellist-container">
                                    ...
                                    <div className=" flex items-start gap-9 max-md:max-w-full max-md:flex-wrap p-2" style={{ width: "40%", justifyContent: "space-evenly" }}>

                                        <FormControl size='small' style={{ minWidth: "30%", borderRadius: "4px" }} >
                                ...
                                <div className="grid grid-cols-2 gap-6 w-full h-full pt-2">
                                    <div className="" onClick={() => openModal('Pie')} >
                                    ...
                                    <div className="" onClick={() => openModal('Bar')}>
                                        <div className="heading-all">Level Of Change (Representational Data)</div>
                                        <div className="content">
                                            <Bar data={graphData} options={options} ></Bar>
                                        </div>
                                    </div>
                                    <div className="" onClick={() => openModal('Doughnut')}>
                                        <div className="heading-all">General Details (Representational Data)</div>
                                        <div className="content">
                                            <Doughnut data={graphData} options={options} ></Doughnut>
                                        </div>
                                    </div>
                                    <div className="" onClick={() => openModal('Line')}>
                                        <div className="heading-all">Purpose of Change (Representational Data)</div>
                                        <div className="content">
                ...
                >
                    <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 400, bgcolor: 'background.paper', border: "none", boxShadow: 24, p: 4, borderRadius: "4px" }}>
                        <IconButton
                            aria-label="close"
                            onClick={closeModal}
                            sx={{
                        ...
                        <Box>
                            {selectedChart === 'Pie' && <Pie data={graphData} options={options} width="200" height="200"></Pie>}
                            {selectedChart === 'Bar' && <Bar data={graphData} options={options} width="200" height="200"></Bar>}
                            {selectedChart === 'Doughnut' && <Doughnut data={graphData} options={options} width="200" height="200"></Doughnut>}
                            {selectedChart === 'Line' && <Line data={graphData} options={options} width="200" height="200"></Line>}
                        </Box>
                    </Box>
                </Modal>
            </div>
            <div>
            <iframe title="Maruti Dashboard_V2" width="1750" height="700.25" src="https://app.powerbi.com/reportEmbed?reportId=a85feb6a-51c5-433a-9aaa-0db8c2008565&autoAuth=true&ctid=d78a8218-4135-4026-a3a8-1cdd7223b4d5" frameborder="0" allowFullScreen="true"></iframe>
            </div>
...
//     // Extracting values from data
//     var commonValue = data[0].common;
//     var uncommonValue = data[0].uncommon;
//     const graphData = {
//         // Only show the currently selected milestone
//         datasets: [{
//             data: [commonValue, uncommonValue],
//             backgroundColor: [
//                 '#118DFF', // Common color
//                 '#12239E'  // Uncommon color
//             ],
...
//             <div className="flex-col relative flex  w-full items-center pl-8 pr-8  max-md:max-w-full max-md:pl-5  modellist-container">
//                 <div className="items-stretch flex flex-col w-full  max-md:max-w-full max-md:flex-wrap">
//                     <div className="text-neutral-700 font-semibold tracking-tight  whitespace-nowrap my-auto" style={{ fontSize: '24px' }}>
//                         Dashboard
//                     </div>
//                     <div>
//                         <div style={{ borderBottom: 1, borderColor: 'divider' }}>
...
//                         {/* Your existing code goes here */}
//                         <div className="">
//                             <div className="flex-col relative flex  w-full items-center max-md:max-w-full max-md:pl-5  modellist-container">
//                                 {/* <div className="rounded shadow bg-white flex w-full flex-col justify-center mt-4 pl-4 pr-4 py-2 items-start max-md:max-w-full max-md:pr-5"> */}
//                                 <div className="items-stretch flex gap-9 max-md:max-w-full max-md:flex-wrap p-2" style={{ width: "40%", justifyContent: "space-evenly" }}>
...
//                                         >
//                                             <MenuItem value={10}>YY17</MenuItem>
//                                             <MenuItem value={20}>YY18</MenuItem>
//                                             <MenuItem value={30}>YY19</MenuItem>
//                                         </Select>
...
//                                         >
//                                             <MenuItem value={10}>Hood System</MenuItem>
//                                             <MenuItem value={20}>Fender System</MenuItem>
//                                             <MenuItem value={30}>Part System</MenuItem>
//                                         </Select>
...
//                                         >
//                                             <MenuItem value={10}>CJ020</MenuItem>
//                                             <MenuItem value={20}>CJ030</MenuItem>
//                                             <MenuItem value={30}>CJ040</MenuItem>
//                                         </Select>
...
//                                 </div>
//                                 <div className="" onClick={() => openModal('Bar')}>
//                                     <div className="heading-all">Level Of Change</div>
//                                     <div className="content">
//                                         <Bar data={graphData} options={options} ></Bar>
//                                     </div>
//                                 </div>
//                                 <div className="" onClick={() => openModal('Doughnut')}>
//                                     <div className="heading-all">General Details</div>
//                                     <div className="content">
//                                         <Doughnut data={graphData} options={options} ></Doughnut>
//                                     </div>
//                                 </div>
//                                 <div className="" onClick={() => openModal('Line')}>
//                                     <div className="heading-all">Purpose of Change</div>
//                                     <div className="content">
//                                         <Line data={graphData} options={options} ></Line>
//                                     </div>
//                                 </div>
